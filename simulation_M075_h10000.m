...
signal_in_delta_e = generate_step(100, 0.01, 10, 11, deg2rad(21.5));
signal_in_delta_a = generate_step(100, 0.01, 20, 21, deg2rad(21.5));
signal_in_delta_r = generate_step(100, 0.01, 30, 31, deg2rad(21.5));
...
%% Performing Interactive Root Locus Analysis + Pole placement for SAS (Initial)

sf_lti_rlocus(Alon, Blon, Alat, Blat, [], [], [], []);

%% Performing Interactive Root Locus Analysis + Pole placement for SAS (Recursive)
